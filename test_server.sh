...
# git clone the repo
git clone git@gitlab.crio.do:COHORT_ME_BUILDOUT_XMEME_ENROLL_1612436694845/mayank-singh081997-me_buildout_xmeme.git

# cd to the cloned repo directory
cd mayank-singh081997-me_buildout_xmeme 
...
curl --location --request POST 'http://localhost:8081/memes' --header 'Content-Type: application/json' --data-raw '{"name": "xyz","caption": "This is a meme","url": "abc.com"}'
